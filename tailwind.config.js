  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'custombutton': 'linear-gradient(90deg, rgba(0, 0, 139, 0.28) 0%, rgba(217, 217, 217, 0.00) 137.42%)',
        'selectday': 'radial-gradient(15.17% 5405.66% at 50.61% 50.72%, rgba(0, 0, 139, 0.28) 0%, rgba(217, 217, 217, 0.00) 100%)',
      }
    },
  },
  darkMode: "class",
