...
export default function Faqs() {
    ...
    return (
        <div className='h-full sm:h-screen bg-custom-blue-3 '>
            <div className='pt-[96px] flex lg:w-8/12 w-[89%] justify-center items-center m-auto'>
            ...
            <div className='lg:w-8/12 w-11/12 m-auto pb-4'>
                <Accor />
            </div>
        </div>
    )
