  ...
  return (
    <div className='flex-col flex items-center justify-center gap-4 '>
      ...
      <div className='bg-gradient-to-l from-custom-blue-3 to-custom-blue-1 w-full rounded-lg'>
        ...
        <div className={`bg-white rounded-lg overflow-hidden ease-in-out duration-300 ${active ? 'max-h-[500px]' : 'max-h-0'}`}>
      ...
      <div className='bg-gradient-to-l from-custom-blue-3 to-custom-blue-1 w-full rounded-lg'>
        ...
        <div className={`bg-white rounded-lg overflow-hidden ease-in-out duration-300 ${active2 ? 'max-h-[500px]' : 'max-h-0'}`}>
      ...
      <div className='bg-gradient-to-l from-custom-blue-3 to-custom-blue-1 w-full rounded-lg'>
        ...
        <div className={`bg-white rounded-lg overflow-hidden ease-in-out duration-300 ${active3 ? 'max-h-[500px]' : 'max-h-0'}`}>
      ...
      <div className='bg-gradient-to-l from-custom-blue-3 to-custom-blue-1 w-full rounded-lg'>
        ...
        <div className={`bg-white rounded-lg overflow-hidden ease-in-out duration-300 ${active4 ? 'max-h-[500px]' : 'max-h-0'}`}>
      ...
      <div className='bg-gradient-to-l from-custom-blue-3 to-custom-blue-1 w-full rounded-lg'>
        ...
        <div className={`bg-white rounded-lg overflow-hidden ease-in-out duration-300 ${active5 ? 'max-h-[500px]' : 'max-h-0'}`}>
