...
const Hexa = () => {
  ...
  return (
    <div className=" w-[500px] absolute top-0 right-0 hidden lg:block  overflow-hidden h-full">
      ...
      <div className="p-4 bg-amber-400 w-2 rounded-full absolute translate-x-[100px] translate-y-[85px] z-50"></div>
      <div className="p-4 bg-amber-400 w-2 rounded-full absolute -translate-x-[100px] translate-y-[85px] z-50 right-0"></div>
      ...
      <div className="p-4 bg-amber-400 opacity-90 w-2 rounded-full absolute  translate-x-[100px] translate-y-[238px] z-50"></div>
      <div className="p-4 bg-amber-400 opacity-90 w-2 rounded-full absolute -translate-x-[100px] translate-y-[238px] right-0 z-50"></div>
      ...
      <div className="p-4 bg-amber-400 w-2 rounded-full absolute left-1/2 -translate-x-1/2 translate-y-[305px] z-50"></div>
      <div className="p-1 w-[283px] bg-white rounded-lg absolute -rotate-[30deg] translate-y-[175px] translate-x-[110px]"></div>
      <div className="p-1 w-[283px] bg-white rounded-lg absolute rotate-[30deg] translate-y-[175px] translate-x-[110px] "></div>
      <div className="p-1 h-full opacity-25 bg-white rounded-lg absolute  left-1/2 -translate-x-1/2"></div>
      <div className="p-4 bg-amber-400 w-2 rounded-full absolute left-1/2 -translate-x-1/2 translate-y-[160px] z-50"></div>
    </div>
  )
}
