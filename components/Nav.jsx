      ...
      <nav className="flex justify-between w-11/12 m-auto py-4 md:w-4/5 ">
        ...
        <div className="md:flex hidden gap-3 md:gap-5">
          ...
          {user.name ? (
            ...
            <div className={`absolute right-0 top-full w-full min-w-[210px] flex flex-col  backdrop-blur-sm bg-neutral-500/50 duration-1000 h-screen  ${toggleDropdown ? "transform-none" : "-translate-x-full"
              }`}  >
