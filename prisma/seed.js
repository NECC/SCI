...
async function main() {
  ...
  await prisma.activity.createMany({
    data: [
      ...
      { "picUrl": "/dia18/Pedro_Gomes.jpg", "title": "Ciência cidadã", "description": "O envolvimento do público na investigação científica amplia a capacidade colaborativa, democratiza a ciência e promove a compreensão pública. Tecnologias digitais facilitam a participação global, diversificando e aumentando os dados disponíveis. A análise breve abordará os benefícios e desafios, destacando exemplos práticos e projetos relevantes.", "date": day18, "startTime": "14:00", "endTime": "15:30", "location": "Campus Gualtar, CP2 - 1.15", "capacity": 50, "speakers": "Pedro Gomes", "type": "WORKSHOP" },
