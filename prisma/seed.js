...
async function main() {
  ...
  await prisma.activity.createMany({
    data: [
      ...
      { "picUrl": "/dia18/Pedro_Gomes.jpg", "title": "Ciência cidadã", "description": "Exploração dos princípios fundamentais que orientam a prática da ciência cidadã, incluindo colaboração, transparência, acessibilidade, engajamento público e qualidade dos dados.", "date": day18, "startTime": "14:00", "endTime": "15:30", "location": "Campus Gualtar, CP2 - 1.15", "capacity": 50, "speakers": "Pedro Gomes", "type": "WORKSHOP" },

      { "picUrl": "/dia18/Filipe_Rocha.jpg", "title": "Computer Aided Drug Discovery", "description": "Aprenda os princípios fundamentais e as técnicas essenciais para o desenvolvimento de novos medicamentos. Inscrições abertas para todos os interessados em explorar esta emocionante área da ciência. É necessário PC e Pymol!", "date": day18, "startTime": "14:00", "endTime": "15:30", "location": "Campus Gualtar - CP6, Auditório ECUM", "capacity": 50, "speakers": "Filipe Rocha", "type": "WORKSHOP" },
      ...
      // ------------------------------------------- Dia 21 -------------------------------------------
      { "picUrl": defaultUrl, "title": "LinkedIn e CV", "description": "Passos para criar um perfil atraente no LinkedIn, incluindo a seleção de uma foto de perfil profissional, a elaboração de um título claro e atraente, e a descrição de experiência profissional e habilidades relevantes.", "date": day21, "startTime": "10:00", "endTime": "12:00", "location": "", "capacity": 50, "speakers": "Vinicius Silva", "type": "WORKSHOP" },
      { "picUrl": defaultUrl, "title": "Astrobiologia", "description": "Neste workshop vai-se começar por explicar a deteção de um exoplaneta ou dum corpo do sistema solar. Após isso irá ser distribuído pelos alunos corpos na forma de AstroDestinos de forma a que seja realizada uma atividade prática.", "date": day21, "startTime": "10:00", "endTime": "12:00", "location": "", "capacity": 50, "speakers": "Associação Portuguesa de Astrobiologia", "type": "WORKSHOP" },
      { "picUrl": defaultUrl, "title": "Geofísica", "description": "Exploração dos diferentes métodos geofísicos utilizados para investigar o subsolo terrestre, incluindo métodos sísmicos (refração e reflexão), métodos eletromagnéticos, métodos gravimétricos e métodos de sensoriamento remoto.", "date": day21, "startTime": "10:00", "endTime": "12:00", "location": "", "capacity": 50, "speakers": "Luís Gonçalves", "type": "WORKSHOP" },
